...
(function () {
  ...
  var RULES = [
    ...
    { id: "school",     validate: function (v) { return v.trim() ? "" : "Vyplňte prosím název školy."; } },
    { id: "schoolType", validate: function (v) { return v ? "" : "Vyberte prosím typ školy."; } },
  ...
  function buildPayload() {
    return {
      ...
      school: fieldEl("school").value.trim(),
      schoolType: fieldEl("schoolType").value,
